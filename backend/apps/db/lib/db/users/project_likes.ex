defmodule Db.Users.ProjectLikes do
    ...
    case Repo.get_by(ProjectLike, attrs) do
      ...
      %ProjectLike{status: :approved} = like ->
        transaction =
          ...
          |> Multi.update(:delete_project_member, Projects.Member.update_changeset(%{project_id: project_id, user_id: user_id, deleted_at: Timex.now}))
  ...
  defp approve(%ProjectLike{project_id: project_id, user_id: user_id} = project_like) do
    ...
    |> Multi.insert_or_update(:add_member_to_project, Projects.Member.changeset(%{project_id: project_id, user_id: user_id}))
