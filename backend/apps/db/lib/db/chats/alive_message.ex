defmodule Db.Chats.AliveMessage do
  @moduledoc """
  ...
  alias Db.Chats.{Chat, AliveMember}
  alias Db.Users.User
  ...
  defp validate_chat_member(changeset) do
    ...
    case Db.Repo.get_by(AliveMember, chat_id: chat_id, user_id: user_id) do
