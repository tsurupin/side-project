defmodule Db.UsersTest do
  ...
  describe "search/1" do
    ...
    test "returns empty record, when only unexpected keyword is included",  %{user1: user1, user2: user2} do
    ...
    test "returns users that has occupation_type, when occupation_type_id is included", %{user2: user2, occupation_type_id: occupation_type_id} do
    ...
    test "returns users that was activated app within the last 3 days, when is_active is included", %{user2: user2} do
    ...
    test "returns users that have these skills, when skill_ids are included", %{user1: user1, skill1_id: skill1_id} do
    ...
    test "returns users matches to the multiple conditions, when multiple conditions are included", %{user2: user2, genre_id: genre_id, occupation_type_id: occupation_type_id} do
