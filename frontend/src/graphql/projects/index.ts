import { CHANGE_PROJECT_STATUS_MUTATION } from './changeProjectStatusMutation';
import { CREATE_PROJECT_MUTATION } from './createProjectMutation';
import { DELTE_PROJECT_PHOTO_MUTATION } from './deleteProjectPhotoMutation';
import { EDIT_PROJECT_MUTATION } from './editProjectMutation';
import { PROJECT_DETAIL_QUERY } from './projectDetailQuery';
